...
def page_zone(ramdump, page) :
    ...
    node_zones_offset = ramdump.field_offset("struct pglist_data", "node_zones")
...
def page_address(ramdump, page) :
    ...
    while True :
        pam = pam - lh_offset
        pam_page_offset = ramdump.field_offset("struct page_address_map","page")
        pam_virtual_offset = ramdump.field_offset("struct page_address_map","virtual")

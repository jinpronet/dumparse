...
def parse_cache_dump(ram_dump, out_path, cache_base) :
    ...
    magic_num_offset = ram_dump.field_offset("struct l2_cache_dump","magic_number")
    version_offset = ram_dump.field_offset("struct l2_cache_dump","version")
    line_size_offset = ram_dump.field_offset("struct l2_cache_dump","line_size")
    total_lines_offset = ram_dump.field_offset("struct l2_cache_dump","total_lines")
    cache_offset_struct = ram_dump.field_offset("struct l2_cache_dump","cache")
    l2dcrtr0_offset_struct = ram_dump.field_offset("struct l2_cache_line_dump","l2dcrtr0_val")
    l2dcrtr1_offset_struct = ram_dump.field_offset("struct l2_cache_line_dump","l2dcrtr1_val")
    cache_line_data_offset_struct = ram_dump.field_offset("struct l2_cache_line_dump","cache_line_data")
...
class CacheDump(RamParser):
    def parse(self):
        ...
        parse_cache_dump(self.ramdump, out_path, cache_base)
